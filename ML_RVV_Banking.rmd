...
Now it has been observed the aforementioned fact, let's try to see how these variables are distributed with boxplots: 
...
Finally, let's analyze Pearson and Spearman correlation between numeric variables and dependdant variable Y, to try to find out if all variables are needed for our candidate models or on the other hand if some variable can be dismissed:
