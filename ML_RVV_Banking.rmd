...
Besides, following approach taken in previous project [ML_RVV_Capstone_Project](https://github.com/rvazquezv/Capstone) I have also included a baseline predictor to set as reference.
